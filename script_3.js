// this is favourite hero page javascript 

//here I get favourites heros id from local storage and store in an array
...
// this is the function for remove hero from favourites, update localstorage and reload page
...
//this is the function for show all favourites heros in html page 
let html="";
function fetchData(){
...
//this is the set timeout function for show all heros in fv-main id
setTimeout(() => {
